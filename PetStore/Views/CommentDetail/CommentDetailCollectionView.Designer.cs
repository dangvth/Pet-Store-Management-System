namespace PetStore.Views.CommentDetailCollectionView {
    partial class CommentDetailCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "CommentDetail Tasks";
			...
			this.commentDetailCollectionViewBindingSource.DataSource = typeof(PetStore.CommentDetail);
			this.gridControl.DataSource = commentDetailCollectionViewBindingSource;
			...
			//Comment
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters CommentPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            CommentPopulateColumnParameters.FieldName = "Comment";
            CommentPopulateColumnParameters.Path = "Comment.cmt_content";
			parameters.CustomColumnParameters.Add(CommentPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters CommentPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            CommentPopulateColumnParameters_NotGenerate.FieldName = "cmt_id";
		    CommentPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(CommentPopulateColumnParameters_NotGenerate);
									//
			//User
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters CommentPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            CommentPopulateColumnParameters_NotVisible.FieldName = "Comment";
		    CommentPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(CommentPopulateColumnParameters_NotVisible);
			...
			this.gridView.PopulateColumns(typeof(PetStore.CommentDetail),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(PetStore.ViewModels.CommentDetailCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(PetStore.ViewModels.CommentDetailCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "CommentDetailCollectionView";
		...
		private System.Windows.Forms.BindingSource commentDetailCollectionViewBindingSource;
